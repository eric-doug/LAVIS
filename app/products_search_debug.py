...
def main():
    ...
    user_question = "Tanabata Valentine's Day Shenzhen Bao'an M Nanshan Futian Luohu Car Decorative Flowers Float Arrangement Holding Chest"
