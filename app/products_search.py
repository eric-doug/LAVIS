...
def load_feat():
    ...
    filepath = '/home/flyingbird/workspace/codes/LAVIS/app/path2feat_ali_products_val.pth'
...
def app():
    ...
    file_root = '/home/flyingbird/workspace/datas/multi-modal/val_imgs/'
    ...
    user_question = st.text_input(
        "Search query", "Tanabata Valentine's Day Shenzhen Bao'an M Nanshan Futian Luohu Car Decorative Flowers Float Arrangement Holding Chest", help="Type something to search."
    )
